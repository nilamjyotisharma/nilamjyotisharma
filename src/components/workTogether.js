  ...
  return (
    <>
      <div className='flex-row justify-start px-14 py-12 items-end'>
              ...
              <div className='flex md:justify-end justify-center text-4xl md:text-4xl drop-shadow-xl  mt-8 text-white dark:text-neutral-400 hover:text-white hover:scale-110 duration-200 cursor-pointer'>
                <Link href={link}>
